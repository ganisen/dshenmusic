...
9. **Safety rule (2026-08-22, owner request), amended 2026-09-01:** the public site carries
   **no reference to Russia and no copy line saying the songs are in Russian**, and no
   VK or Zvuk link. Never re-add those — not from CONTENT.md, not from the design mock,
   not from a distributor feed. **Exception (owner, 2026-09-01): the Yandex Music footer
   icon is back, gated `data-lang-only="ru"` — it renders on the RU version only.** Do not
   surface it in EN / RO / UA. The four UI languages, RU included, stay.
   See the 2026-08-22 and 2026-09-01 entries in HANDOFF.md.
